...
| The site picker switch appears ineffective | Install the latest extension, toggle **This site** off, and refresh the page. Downloads should still be captured but should bypass the picker and go directly to Motrix. |
