  ...
  return (
    <header className='space-y-2 px-3 py-2.5'>
      ...
      {currentSitePattern
        ? (
            <div
              className='flex min-w-0 items-center justify-between gap-3 rounded-xl border bg-(--m3-surface-container) px-2.5 py-1.5'
              title={currentSitePattern}
            >
              <div className='min-w-0'>
                <div className='text-[10px] font-semibold'>{t('popup.siteLabel')}</div>
                <div className='truncate text-[10px] text-muted-foreground'>{currentSitePattern}</div>
              </div>
              <Switch
