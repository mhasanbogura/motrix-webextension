export const enUS = {
  ...
  popup: {
    ...
    captureOff: 'Paused',
    siteLabel: 'Site File Picker',
    siteToggle: 'Enable or disable the picker for this site',
    pauseAll: 'Pause all',
  ...
  options: {
    ...
    promptBeforeDownload: 'Open IDM-style picker before handoff',
    promptBeforeDownloadHint: 'Review the filename and directory before sending a task to Motrix.',
    hideChromeDownload: 'Hide Chrome download record',
    protocols: 'Captured protocols',
    captureTypes: 'Download capture types',
    captureTypesHint: 'Choose which file categories Motrix should capture.',
    captureAudio: 'Audio',
    captureVideo: 'Video',
    captureImage: 'Images',
    ...
    siteFilePicker: 'Site File Picker',
    siteFilePickerHint: 'These site-specific switches control only the purple in-page Download with Motrix button. They do not block normal capture.',
    noPickerRules: 'No Site File Picker sites saved yet. Toggle the picker for a site in the popup to save it here.',
